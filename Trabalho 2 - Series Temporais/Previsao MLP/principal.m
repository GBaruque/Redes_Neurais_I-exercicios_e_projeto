...
microclima=6;  % opcoes 1-8
codificacao=3;% opcoes 1=real, 2=4bits, 3=12bits
janela=7; % 
Num=8; % Numero de redes a testar

%% Parametros da rede

Numproc=10; % Numero de processadores
tipofunc='logsig'; % logsig tansig
funcsaida='purelin'; % purelin logsig
algtrei='trainlm'; % trainlm traingd traingdm traingdx
Nepoch=2000; % Numero de epocas
Numchkval=1000; % Se Numchkval=Nepoch --> Sem (early stop); Se Numchkval<Nepoch --> Com (early stop)
